...
if (!deploy.includes('workflow_run:') || !deploy.includes('workflows: ["AI Akademie P5 release gate"]')) fail('deploy must be chained from the P5 workflow');
...
console.log('[SAFE-PROMOTION] PASS: candidate -> P5 -> PR -> required checks -> protected main -> main P5 -> verified Pages deploy.');
