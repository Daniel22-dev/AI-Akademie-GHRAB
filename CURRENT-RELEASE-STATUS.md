...
**Overall public/school release status:** CONDITIONAL — GH-12 binary/media rights provenance remains open
...
- GH-12 binary/media rights: OPEN; see `security/BINARY-RIGHTS-INVENTORY.txt`.

## Remaining blocker before unconditional PUBLIC/SCHOOL closure
For each deployed image/SVG in `security/BINARY-RIGHTS-INVENTORY.txt`, record one of:
- OWN WORK
- SCHOOL-OWNED-AUTHORIZED
- LICENSED (with source/license)
- REPLACED

Until GH-12 is documented, the technical release may be GREEN, but the overall public/school release must not be described as fully closed.
