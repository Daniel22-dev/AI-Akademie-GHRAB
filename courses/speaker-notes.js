...
export default {
  ...
  "ai-literacy/good-task": {
    ...
    "explain": [
      ...
      "Pro koho a z čeho: Předmět, ročník, úroveň, čas, zdrojový materiál a situace.",
  ...
  "ai-literacy/takeaway": {
    ...
    "explain": [
      ...
      "Dávám kontext: Dodám kvalitní podklad, publikum, omezení a kritéria.",
  ...
  "start/access": {
    ...
    "explain": [
      ...
      "Vyberte způsob aktivace: Nejjednodušší je načíst soubor s příponou .ghrab-access.json. Záložní možností je vložit textový kód začínající ghrab1….",
  ...
  "differentiator/source": {
    ...
    "explain": [
      ...
      "Skupina: Ročník, věk, úroveň a důležitý kontext.",
  ...
  "differentiator/settings": {
    ...
    "explain": [
      ...
      "Standardní varianta: Referenční úroveň odpovídající běžnému očekávání pro danou skupinu.",
  ...
  "differentiator/generation": {
    ...
    "explain": [
      ...
      "Porovnejte vzdělávací cíl: Všechny varianty musí směřovat k tomu, co jste zadali jako společný výsledek.",
  ...
  "differentiator/export": {
    ...
    "explain": [
      ...
      "Jasné zadání: Každá verze má všechny potřebné instrukce a prostor pro práci.",
  ...
  "differentiator/next": {
    ...
    "explain": [
      ...
      "Komunikace: Korespondenční asistent bez nutnosti GitHubu.",
  ...
  "github/account": {
    ...
    "explain": [
      ...
      "Zvolte New repository: Repozitář pojmenujte například interaktivni-materialy nebo vyukove-hry.",
  ...
  "github/upload": {
    ...
    "explain": [
      ...
      "Zvolte Add file → Upload files: Soubor lze přetáhnout do označené oblasti nebo vybrat z disku.",
  ...
  "github/update": {
    ...
    "explain": [
      ...
      "Nahrajte ji do stejného místa repozitáře: GitHub změnu rozpozná jako aktualizaci existujícího souboru.",
  ...
  "generator/input": {
    ...
    "explain": [
      ...
      "Určete režim a úroveň: Zadejte ročník, očekávanou úroveň a zda jde o procvičování nebo test.",
  ...
  "generator/tasks": {
    ...
    "explain": [
      ...
      "Střídejte nároky: Kombinujte rozpoznání, aplikaci a produkci podle cíle.",
  ...
  "generator/differentiation": {
    ...
    "explain": [
      ...
      "Nedoporučeno: seznam skutečných jmen, diagnózy ve volném textu.",
  ...
  "generator/export": {
    ...
    "explain": [
      ...
      "Běžný test: Zvolte kontrolovaný způsob spuštění a ověřte, co žák uvidí po odevzdání.",
  ...
  "ludus/route": {
    ...
    "explain": [
      ...
      "Import ze Studia: Převezmete krátkodobé anonymní předání nebo soubor ghrab-material.",
  ...
  "ludus/content": {
    ...
    "explain": [
      ...
      "Rozdělte učivo do stanic: Každá stanice má jeden srozumitelný úkol.",
  ...
  "ludus/teacher-mode": {
    ...
    "explain": [
      ...
      "Záchranné ovládání: Pozastavení, návrat, reset nebo řešení nestandardní situace.",
  ...
  "ludus/test-export": {
    ...
    "explain": [
      ...
      "Otevřete HTML mimo LUDUS: Vyzkoušejte start, průběh a ukončení.",
  ...
  "correspondence/anonymisation": {
    ...
    "explain": [
      ...
      "Anonymizovaná verze: [ŽÁKYNĚ] z [TŘÍDA], [TELEFON].",
  ...
  "correspondence/analysis": {
    ...
    "explain": [
      ...
      "Požadavek: Co odesílatel explicitně nebo nepřímo očekává.",
  ...
  "correspondence/own-email": {
    ...
    "explain": [
      ...
      "Napište cíl zprávy: Například potvrdit, požádat, vysvětlit, odmítnout nebo navrhnout řešení.",
  ...
  "correspondence/final-check": {
    ...
    "explain": [
      ...
      "Tón: Odpovídá vztahu a závažnosti situace?",
  ...
  "evaluator/input": {
    ...
    "explain": [
      ...
      "Celá skupina: Až dvacet prací, seskupování a řízená fronta.",
  ...
  "evaluator/privacy": {
    ...
    "explain": [
      ...
      "Do AI požadavku: pseudonymní kód, zkontrolovaný text práce.",
  ...
  "evaluator/rubric": {
    ...
    "explain": [
      ...
      "Důkazy v textu: Každé zásadní hodnocení má být doložitelné konkrétní částí práce.",
  ...
  "evaluator/batch": {
    ...
    "explain": [
      ...
      "Potvrďte přepisy obrazových prací: Nesprávný přepis vede k nesprávnému hodnocení.",
  ...
  "evaluator/export": {
    ...
    "explain": [
      ...
      "Třídní přehled: Body, známky a anonymní analytika.",
  ...
  "workflow/source-model": {
    ...
    "explain": [
      ...
      "Cíl: Pozorovatelný výsledek práce žáka.",
  ...
  "workflow/quality-gate": {
    ...
    "explain": [
      ...
      "Správnost: Jsou fakta, řešení a výpočty ověřené?",
  ...
  "workflow/team": {
    ...
    "explain": [
      ...
      "Výstupy: PDF, HTML, hra nebo test s jasným účelem.",
  ...
  "administrator/learning-path": {
    ...
    "explain": [
      ...
      "Univerzální praxe: Diferenciátor jako první hmatatelný výsledek.",
  ...
  "administrator/registry": {
    ...
    "explain": [
      ...
      "Rozsah: Které aplikace a role obsahuje.",
  ...
  "administrator/delivery": {
    ...
    "explain": [
      ...
      "Krátké vysvětlení: Pouze nezbytný princip a bezpečnostní pravidlo.",
  ...
  "administrator/support": {
    ...
    "explain": [
      ...
      "Technický problém: Aplikace je zamčená, API klíč je odmítnut.",
